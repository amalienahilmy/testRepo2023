...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bms', '0028_alter_booking_checkin_date_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='booking',
            name='checkin_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 10, 21, 45, 13, 901405)),
        ),
        migrations.AlterField(
            model_name='booking',
            name='checkout_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 11, 21, 45, 13, 901405)),
        ),
        migrations.AlterField(
            model_name='booking',
            name='updated_by',
