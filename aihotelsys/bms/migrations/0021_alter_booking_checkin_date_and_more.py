...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bms', '0020_remove_roomtype_type_roomtype_code_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='booking',
            name='checkin_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 10, 21, 19, 28, 497361)),
        ),
        migrations.AlterField(
            model_name='booking',
            name='checkout_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 7, 11, 21, 19, 28, 497361)),
        ),
        migrations.AlterField(
            model_name='booking',
            name='updated_by',
